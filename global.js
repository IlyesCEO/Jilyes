...
setInterval(() => {
  if (favimg.src == "/chevron.png") {
    if (arrowfavorite.style.background == "inherit") {
      arrowfavorite.style.background = "wheat";
    } else {
      arrowfavorite.style.background = "inherit";
    }
  }
}, 5000);
...
async function dailyphp() {
  ...
  dailyImage.innerHTML += `<p>Today's Recipe</p>`;
